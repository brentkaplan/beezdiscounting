...
These modeling tiers, together with 21-item MCQ and 30-item PDQ scoring, are
included in version 0.4.0, which is being submitted to CRAN; the CRAN release
available today is 0.3.2, which contains only the scoring and NLS tools (see
Installing, below, for how to get each version). Full
