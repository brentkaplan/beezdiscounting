...
discount rate estimated on the same natural-log scale. Nothing in this
vignette runs at build time (Stan sampling takes minutes); copy the
chunks into your session. brms, posterior, and loo are suggested
packages.
