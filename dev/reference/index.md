...
## Linearized Mazur (closed form)

Analytic ln k, closed-form random-effects MLEs, and an exact F-test
across conditions (Hinds et al., 2026).
...
- [`print(`*`<beezdiscounting_linear>`*`)`](https://brentkaplan.github.io/beezdiscounting/reference/beezdiscounting_linear-methods.md)
  [`summary(`*`<beezdiscounting_linear>`*`)`](https://brentkaplan.github.io/beezdiscounting/reference/beezdiscounting_linear-methods.md)
  [`print(`*`<summary.beezdiscounting_linear>`*`)`](https://brentkaplan.github.io/beezdiscounting/reference/beezdiscounting_linear-methods.md)
  [`tidy(`*`<beezdiscounting_linear>`*`)`](https://brentkaplan.github.io/beezdiscounting/reference/beezdiscounting_linear-methods.md)
  [`glance(`*`<beezdiscounting_linear>`*`)`](https://brentkaplan.github.io/beezdiscounting/reference/beezdiscounting_linear-methods.md)
  [`coef(`*`<beezdiscounting_linear>`*`)`](https://brentkaplan.github.io/beezdiscounting/reference/beezdiscounting_linear-methods.md)
  [`confint(`*`<beezdiscounting_linear>`*`)`](https://brentkaplan.github.io/beezdiscounting/reference/beezdiscounting_linear-methods.md)
  [`augment(`*`<beezdiscounting_linear>`*`)`](https://brentkaplan.github.io/beezdiscounting/reference/beezdiscounting_linear-methods.md)
  [`predict(`*`<beezdiscounting_linear>`*`)`](https://brentkaplan.github.io/beezdiscounting/reference/beezdiscounting_linear-methods.md)
  [`nobs(`*`<beezdiscounting_linear>`*`)`](https://brentkaplan.github.io/beezdiscounting/reference/beezdiscounting_linear-methods.md)
  [`logLik(`*`<beezdiscounting_linear>`*`)`](https://brentkaplan.github.io/beezdiscounting/reference/beezdiscounting_linear-methods.md)
...
- [`anova(`*`<beezdiscounting_linear>`*`)`](https://brentkaplan.github.io/beezdiscounting/reference/anova.beezdiscounting_linear.md)
  : F-test for condition means in a linearized Mazur fit (Hinds et al.
  2026, Prop. 3.5)
- [`simulate_dd_linear()`](https://brentkaplan.github.io/beezdiscounting/reference/simulate_dd_linear.md)
  : Simulate indifference points from the linearized Mazur
  random-effects model

## Power analysis

Monte Carlo power estimation and sample-size search for between-subject
discounting designs.
...
Scoring, lookup, and reshaping for the 30-item PDQ (Madden, Petry, &
Johnson, 2009), scored per block with the Gray et al. (2016)
consistency-maximization conventions.
...
- [`plot(`*`<prop_sc_output>`*`)`](https://brentkaplan.github.io/beezdiscounting/reference/plot.prop_sc_output.md)
...
- [`pdq`](https://brentkaplan.github.io/beezdiscounting/reference/pdq.md)
