...
- items:
  ...
  Maraković, 1996). Default is 27.

- id_var, question_var, response_var:

  Column names in `responses` for the subject id, MCQ question id, and
  the binary choice. Defaults match the bundled `mcq27` dataset
