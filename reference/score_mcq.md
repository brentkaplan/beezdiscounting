...
- items:
  ...
  Number of MCQ items: 27 (Kirby, Petry, & Bickel, 1999) or 21 (Kirby &
  Marakovic, 1996). Default is 27.
...
canonical question id (`items` of them; no duplicates, no unknown ids,
none missing) and responses coded 0, 1, or `NA` (numeric, logical, or
